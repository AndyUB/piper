...
LOG_DIR=logs-force-sync
mkdir -p $LOG_DIR
RAY_TMP=$HOME/ray_tmp
mkdir -p $RAY_TMP
export RAY_TMPDIR="$RAY_TMP"
export CUDA_VISIBLE_DEVICES=3,1,2 # worked for LLAMA_DEBUG
...
python3 -m test.test_llama \
    ...
    --num_stages 4 \
    --schedule interleaved-1f1b \
    --model LLAMA_3B > $LOG_DIR/interleaved_1f1b_3b_gpu312.log 2>&1
...
#     --tracing \
#     --schedule interleaved-1f1b \
#     --model LLAMA_3B > $LOG_DIR/interleaved_1f1b_3b_gpu012-nsys-min_v3-dashboard.trace 2>&1

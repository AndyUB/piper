...
def piper_setup(
    ...
    Args:
        ...
        optim_fn: A callable that accepts a list of parameters and returns an optimizer.
        example_inputs: Example inputs for tracing.
        example_outputs: Example outputs (labels) for tracing.
        schedule: 2D schedule grid (rank x time_step).
        naive_gradient_sync: If True, use a simple all-reduce after all microbatches
            rather than pipelined per-param hooks. Ignored when zero_stage >= 1.
